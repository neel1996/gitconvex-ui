        ...
        if (line[0] && line[0] === "+") {
          return (
            <div
              ...
              key={`${line}-${uuidv4()}`}
            >
              <div className="w-10 px-2 text-center box-content text-green-500 font-mono truncate border-r-2 border-green-500">
                {++lineCounter}
              </div>
          ...
          return (
            <div
              ...
              key={`${line}-${uuidv4()}`}
            >
              <div className="w-10 px-2 text-center box-content text-red-500 font-mono truncate border-r-2 border-red-500">
                -
              </div>
              <pre className="w-5/6 mx-2">
                <code
          ...
          if (line[0]) {
            return (
              <div
                ...
                key={`${line}-${uuidv4()}`}
              >
                <div className="w-10 px-2 text-center box-content text-gray-300 font-mono truncate border-r-2">
                  {++lineCounter}
                </div>
                <pre className="w-5/6">
                  <code
